			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="card">
						...
						<h6>
							<center>Bãi xe đã đầy,xin phải chờ đợi.</center>
						</h6>
						<%
							}
						%>
						...
						<div class="card-body card-block ">
							<form action="AddVehicle" method="post" accept-charset="character_set">
								<p style="font-size: 16px; color: red" align="center">
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="select" class=" form-control-label">Lựa chọn loại phương tiện</label>
									</div>
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">Hãng xe </label>
									</div>
									<div class="col-12 col-md-9">
										<input type="text" id="vehcomp" name="vehcomp"
											class="form-control" placeholder="Nhập hãng xe"
											required="true">
									</div>
								</div>
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">Biển số xe</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<input type="text" id="ownername" name="ownername"
											class="form-control" placeholder="Nhập tên người gửi" required="true">
									</div>
								</div>
								<div class="row form-group">
									<div class="col col-md-3">
								...
								<p style="text-align: center;">
									<button type="submit" class="btn btn-primary btn-md" style="padding-left: 2.5rem; padding-right: 2.5rem;"
										name="submit">Thêm phương tiện</button>
								</p>
							</form>
						</div>
