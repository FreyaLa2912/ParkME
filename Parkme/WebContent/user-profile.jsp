...
<title>Parkme - Thông tin khách hàng</title>
					...
					<div class="page-header float-right">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li><a href="user-profile.jsp">Thông tin</a></li>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong>Thông tin khách hàng</strong>
						</div>
							...
							<form action="" method="post">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">Họ và tên</label>
									</div>
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="email-input" class=" form-control-label">Số điện thoại</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="disabled-input" class=" form-control-label">Địa chỉ</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="disabled-input" class=" form-control-label">Tài khoản</label>
									</div>
									<div class="col-12 col-md-9">
										<input class="form-control " id="email" name="email"
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="disabled-input" class=" form-control-label">Mật khẩu</label>
									</div>
									<div class="col-12 col-md-9">
										<input class="form-control " id="email" name="email"
