...
<title>Parkme - Thông tin quản lý</title>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong>Thông tin quản lý </strong> 
						</div>
						<p>
							<%
						...
						<h6>
							<center>Thông tin đã được cập nhập thành công.</center>
						</h6>
						<%
							}
						%>
							...
							<form action="AdminUpdateDetails" method="post">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">Tên quản lý</label>
									</div>
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="email-input" class=" form-control-label">Tên người dùng</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="password-input" class=" form-control-label">Số điện thoại</label>
									</div>
									<div class="col-12 col-md-9">
