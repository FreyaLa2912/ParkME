...
<title>Parkme - Xem xe khách hàng</title>
					...
					<div class="page-header float-right">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li><a href="manage-incomingvehicle.jsp">Quản lý xe </a></li>
								<li class="active">Quản lý xe vào</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">Quản lý xe vào</strong>
						</div>
						<div class="card-body">
							<table class="table">
								<thead>
								...
								<tr>
									...
									<td><a
										href="view-incomingvehicle-detail.jsp?viewid=<%=resultset.getInt(1)%>">Xem</a>
