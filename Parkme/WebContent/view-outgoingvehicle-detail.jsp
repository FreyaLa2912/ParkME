...
<head>
<title>Parkme - Xem thông tin xe đã rời bãi</title>
					...
					<div class="page-header float-right">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li><a href="manage-outgoingvehicle.jsp">Xem thông tin xe</a></li>
								<li class="active">Xem thông tin xe ra</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong class="card-title">Xem thông tin xe ra</strong>
						</div>
						<div class="card-body">
							<%
							...
							<div>
								<p style="text-align: center;">
									<input type="button" value="Quay lại"
										onclick="history.back()" class="btn btn-primary btn-md" style="padding-left: 2.5rem; padding-right: 2.5rem;">
								</p>
							</div>
						</div>
					</div>
