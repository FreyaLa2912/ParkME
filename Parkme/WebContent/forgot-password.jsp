		...
		<div class="container">
			<div class="login-content">
				...
				<div class="login-form">
					<p class="text-center font-weight-bold text-primary">TÌM MẬT KHẨU</p>
					<form action="reset-password.jsp" method="post">
						<div class="form-group">
							<label>Số điện thoại</label> <input type="text"
								...
								placeholder="Nhập số điện thoại" required="true">
						</div>
						<div class="checkbox fw-bold">
							<label class="pull-right"> <a class="font-weight-bold" href="admin-login.jsp">Đăng nhập - Admin</a>
							</label>
						</div>
						<button type="submit" name="submit"
							class="btn btn-success btn-flat m-b-30 m-t-30">Tìm lại mật khẩu</button>
					</form>
				</div>
			</div>
		</div>
