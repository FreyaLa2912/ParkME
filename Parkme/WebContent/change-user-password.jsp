...
<title>Parkme - Thay đổi mật khẩu khách hàng</title>
					...
					<div class="page-header float-right">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li><a href="change-user-password.jsp">Thay đổi mật khẩu</a></li>
								<li class="active">Thay đổi mật khẩu</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<strong>Thay đổi mật khẩu </strong>
						</div>
							...
							<form action="UserPasswordChange" method="post">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="text-input" class=" form-control-label">Mật khẩu hiện tại</label>
									</div>
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="email-input" class=" form-control-label">Mật khẩu mới</label>
									</div>
									<div class="col-12 col-md-9">
								...
								<div class="row form-group">
									<div class="col col-md-3">
										<label for="password-input" class=" form-control-label">Nhập lại mật khẩu</label>
									</div>
									<div class="col-12 col-md-9">
